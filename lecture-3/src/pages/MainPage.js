...
function MainPage(props) {
  ...
  useLazyLoading(targetRef1);
  useLazyLoading(targetRef2);
  useLazyLoading(targetRef3);

  return (
    <div className="-mt-16 MainPage">
      <BannerVideo />
        ...
        <TwoColumns
          ...
          columns={[
            <picture>
              ...
              <img ref={targetRef1} data-src={main_items} />
            </picture>,
            <Meta
              title={'Items'}
              content={
        ...
        <TwoColumns
          ...
          columns={[
            ...
            <picture>
              ...
              <img ref={targetRef2} data-src={main_parts} />
            </picture>,
          ]}
          mobileReverse={true}
        />
        <TwoColumns
          ...
          columns={[
            <picture>
              ...
              <img ref={targetRef3} data-src={main_styles} />
            </picture>,
            <Meta
              title={'Riding Styles'}
              content={
